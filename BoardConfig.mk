...
DEVICE_PATH := device/schok/SV55216
...
TARGET_KERNEL_CONFIG := SV55216_defconfig
TARGET_KERNEL_SOURCE := kernel/schok/SV55216
...
BOARD_SUPER_PARTITION_GROUPS := schok_dynamic_partitions
BOARD_SCHOK_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product system_ext
BOARD_SCHOK_DYNAMIC_PARTITIONS_SIZE := 9122611200 # TODO: Fix hardcoded value
